...
function NewPost() {
  ...
  const isValidEmbedCode = (code) => {
    ...
    //there isn't a iframe around it just a div and ends in script
    const iframePattern = /<iframe.*<\/iframe>/;
    return iframePattern.test(code);
  };

  //here is the embed code
  //<div class="strava-embed-placeholder" data-embed-type="activity" data-embed-id="10597199340" data-style="standard"></div><script src="https://strava-embeds.com/embed.js"></script>
  //I need to cut embedType, id, style
  //find data-embed-type and start after = and first " and end at the last "
  const handleInputChange = (e) => {
    const code = e.target.value;
    if (isValidEmbedCode(code)) {
      setEmbedCode(code);
      //cut up the string and find the type="activity", id="10597199340" and style="standard" all as a state of objects and send
